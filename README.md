<div align="center">
  <img src="src/app/apple-icon.png" alt="JTResume Logo" width="120" />
...
_Craft pixel-perfect, ATS-compliant resumes with cutting-edge AI enhancements, bank-grade encryption, and a breathtaking glassmorphic dark-mode UI._
...
- **Zero-Trust Encryption**: Client-side AES encryption ensures your sensitive resume data is encrypted _before_ it ever touches the server.
...
| **Typography**    | Google Fonts (_Outfit, Inter, Merriweather, Playfair Display_) |
