...
export default function App() {
    ...
    if (currentView === "editor" && currentResumeId && !isInitializing) {
      const timer = setTimeout(async () => {
        ...
        try {
          ...
          const payloadData = e2eeKey
            ? encryptData(formData, e2eeKey)
            : formData;
  ...
  const fieldTips = {
    fullName:
      "💡 Pro Tip: Use your standard full professional name. Avoid abbreviations or nicknames to ensure maximum ATS matching.",
    jobTitle:
      "💡 Pro Tip: Match your target job title exactly (e.g. 'Senior Systems Architect') to fit automated job criteria.",
    contact:
      "🔒 Privacy Tip: Do not include full street addresses. City, State/Province (e.g. 'Seattle, WA') is sufficient and safe.",
    summary:
      "💡 Style Tip: Keep summaries under 3-4 sentences. Highlight your highest impact credentials, action verbs, and core metrics.",
    sensitive:
      "⚠️ Compliance Risk: Do NOT add photos, birthdates, or marital details. Equal opportunity employment rules in US/CA/AU discourage these.",
    experience_bullets:
      "💡 Pro Tip: Quantify achievements with metrics (e.g., 'reduced load times by 40%') rather than just listing basic responsibilities.",
    skills:
      "💡 Formatting Tip: Group skills into categories (e.g., 'DevOps', 'Languages') and list tags separated by commas.",
  };
  ...
  const handlePasswordChange = async (data) => {
    ...
    try {
      ...
      setPasswordMessage({
        type: "success",
        text: responseData.message || "Password updated!",
      });
      resetPassword();
  ...
  const handleExportData = async () => {
    ...
    try {
      ...
      const exportBlob = new Blob(
        [JSON.stringify({ user, resumes: exportedResumes }, null, 2)],
    ...
    >
              ...
              fetch(`/api/resumes/${id}`)
                ...
                .then((data) => {
                  if (data.success && data.resume) {
                    ...
                    if (data.resume.spacingTuning)
                      setSpacingTuning(data.resume.spacingTuning);
                    if (data.resume.fontPairing)
                      setFontPairing(data.resume.fontPairing);
                  }
                });
            }}
          />
                  ...
                  style={{
                    ...
                    color:
                      editProfileMessage.type === "success"
                        ? "#34d399"
                        : "#f87171",
                    border: `1px solid ${editProfileMessage.type === "success" ? "rgba(16,185,129,0.2)" : "rgba(239,68,68,0.2)"}`,
                  }}
                >
                  {editProfileMessage.text}
                </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        borderRadius: "10px",
                        background: "rgba(0,0,0,0.2)",
                        border: `1px solid ${profileErrors.email ? "#ef4444" : "rgba(255,255,255,0.1)"}`,
                        color: "#fff",
                        fontSize: "14px",
                        transition: "border-color 0.2s",
                      }}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        borderRadius: "10px",
                        background: "rgba(0,0,0,0.2)",
                        border: `1px solid ${profileErrors.phone ? "#ef4444" : "rgba(255,255,255,0.1)"}`,
                        color: "#fff",
                        fontSize: "14px",
                        transition: "border-color 0.2s",
                      }}
                          ...
                          <div style={{ marginBottom: "16px" }}>
                            <input
                              ...
                              style={{
                                ...
                                border: `1px solid ${passwordErrors.currentPassword ? "#ef4444" : "rgba(255,255,255,0.1)"}`,
                                color: "#fff",
                                fontSize: "13px",
                                transition: "border-color 0.2s",
                              }}
                          ...
                          <div style={{ marginBottom: "16px" }}>
                            <input
                              ...
                              style={{
                                ...
                                borderRadius: "8px",
                                background: "rgba(0,0,0,0.3)",
                                border: `1px solid ${passwordErrors.newPassword ? "#ef4444" : "rgba(255,255,255,0.1)"}`,
                                color: "#fff",
                                fontSize: "13px",
                                transition: "border-color 0.2s",
                              }}
                          ...
                          <div style={{ marginBottom: "20px" }}>
                            <input
                              ...
                              style={{
                                ...
                                borderRadius: "8px",
                                background: "rgba(0,0,0,0.3)",
                                border: `1px solid ${passwordErrors.confirmPassword ? "#ef4444" : "rgba(255,255,255,0.1)"}`,
                                color: "#fff",
                                fontSize: "13px",
                                transition: "border-color 0.2s",
                              }}
      ...
      {currentView === "editor" && (
        ...
        >
            ...
            >
                  ...
                  {[
                    {
                      ...
                      num: 1,
                      label: "Profile",
                      done: !!formData.personalInfo.fullName,
                    },
                    {
                      key: "experience",
                      num: 2,
                      label: "Work",
                      done: formData.workExperience.length > 0,
                    },
                    {
                      key: "education",
                      num: 3,
                      label: "Edu",
                      done: formData.education.length > 0,
                    },
                    {
                      key: "skills",
                      num: 4,
                    ...
                    <React.Fragment key={step.key}>
                      ...
                      >
                        <div
                          className={`step-circle ${activeSection === step.key ? "active" : ""} ${step.done ? "done" : ""}`}
                        >
                          {step.done ? "✓" : step.num}
                        </div>
                        <span
                          className={`step-label ${activeSection === step.key ? "active" : ""} ${step.done ? "done" : ""}`}
                        >
                          {step.label}
                        </span>
                      </div>
                      {idx < 3 && (
                        <div
                          className={`step-line ${step.done ? "active" : ""}`}
                        ></div>
                      )}
                    </React.Fragment>
                  ))}
              ...
              {focusedFieldTip && fieldTips[focusedFieldTip] && (
                <div className="px-3 pb-2">
                  <div
                    className="m-0 py-2 px-3 rounded-3"
                    style={{
          ...
          <div
            className={`app-canvas bg-dark flex-column align-items-center h-100 overflow-y-auto p-4 ${mobileTab === "preview" ? "d-flex" : "d-none d-lg-flex"}`}
          >
                  ...
                  {[
                    {
                      ...
                      desc: "Traditional centered serif for finance, law, & consulting",
                    },
                    {
                      id: "modern",
                      label: "Modern Minimalist",
                      desc: "Sleek, highly polished standard for general corporate sectors",
                    },
                    {
                      id: "creative",
                      label: "Creative Executive",
                      desc: "Premium 2-column sidebar design to maximize layout hierarchy",
                    },
                    {
                      id: "executive",
                      label: "Executive Prestige",
                      desc: "Bold, structured corporate header layout for leadership impact",
                    },
                    {
                      id: "tech",
                      label: "Tech Minimalist",
                      desc: "High-density tech presentation with dynamic skill badge rows",
                    },
                    {
                      id: "academic",
                      ...
                      >
                        <div
                          style={{
                            ...
                            fontSize: "0.82rem",
                            color:
                              templateStyle === tpl.id ? "#fff" : "#e2e8f0",
                            marginBottom: "4px",
                          }}
                        >
                          {tpl.label}
          ...
          <div
            className="mobile-bottom-nav d-lg-none d-flex position-fixed bottom-0 start-0 w-100 bg-dark border-top border-secondary"
